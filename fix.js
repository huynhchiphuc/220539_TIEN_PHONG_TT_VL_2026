...
const startToken = '<div className="settings-card">';
...
const newJSX = `<div className="settings-card">
...
const targetContent = fullJSX.substring(0, startIdx) + newJSX + '\\n                            ' + fullJSX.substring(startIdx + lastDivIdx + 6);
